namespace TestPipelineStorageProviders
{
    ...
    public class TestStringTraitsPipelineProvider
    {
        ...
        {
            var connectionString = "{\"ErrorMode\":\"TEST_ERROR_MODE\",\"PipelineExecutionMode\":\"TEST_PIPELINE_EXECUTION_MODE\",\"PipelineSteps\":[{\"__type\":\"TraitsPipelineStep:#TraitsQuickStart.Foundation.Pipelines\",\"Provider\":null,\"ProviderName\":\"PipelineStep1\"},{\"__type\":\"TraitsPipelineStep:#TraitsQuickStart.Foundation.Pipelines\",\"Provider\":null,\"ProviderName\":\"PipelineStep2\"}]}";
