...
namespace TraitsQuickStart.Foundation.Pipelines
{
    ...
    /// </summary>
    [DataContract]
    [KnownType(typeof(TraitsPipelineStep))]
    /// TraitsPipelineStep
    public class TraitsPipeline : ITraitsPipeline
    {
        /// <summary>
        /// If empty uses default pipeline storage format otherwise contains the name of the type used for serialization
        /// </summary>
        [DataMember]
        public string PipelineFormatType { get; set; }
        ...
        /// </summary>
        [DataMember]
        public List<ITraitsPipelineStep> PipelineSteps { get; set; } = new List<ITraitsPipelineStep>();
    }
}
